...
tidy_df |> 
  mutate(Metric = case_when(Metric %in% "Number of workers in State Company for Maritime Transport" ~ "Number of Workers")) -> tidy_df
...
subtitle <- ""
glue("Number of Workers of the State Company for Maritime Transport") -> title
...
#OUTPUTTING THE FILE
ggsave(filename = "sea_number_of_workers_State Company for Maritime Transport.png",
       path = here("results"),
