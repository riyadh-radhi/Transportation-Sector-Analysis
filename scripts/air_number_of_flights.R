...
tidy_df |> 
  mutate(Metric = case_when(Metric %in% "landing_departing_Iraqi airways_international_internal" ~ "Iraqi Airways Flights Number",
                            Metric %in% "landing_departing_all_airways_international_internal" ~ "All Airlines Flights Number")) -> tidy_df
...
subtitle <- ""
glue("Number of Flights in Iraq over the Years") -> title
...
#OUTPUTTING THE FILE
ggsave(filename = "air_number_of_flights.png",
       path = here("results"),
